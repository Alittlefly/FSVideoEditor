...
#define FSSafeAreaBottomHeight ([[UIScreen mainScreen] bounds].size.height == 812.0 ? 34 : 0)
#define FSSafeAreaTopHeight ([[UIScreen mainScreen] bounds].size.height == 812.0 ? 24 : 0)
