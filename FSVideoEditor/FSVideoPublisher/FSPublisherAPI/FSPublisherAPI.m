...
- (void)publisherVideo:(id)param {
    ...
    NSURLSessionTask *task = [manager POST:@"http://www.7nujoom.com/video/index/publish/video" parameters:param progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
